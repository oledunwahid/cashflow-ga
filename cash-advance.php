...
<div class="row">
            ...
            <div class="card-header border-0">
                <div class="d-flex align-items-center">
                    <div class="card-title mb-0 flex-grow-1">
                        ...
                        <h6>Submit your cash advance requests here. Our finance team will process your request as soon as possible.</h6>
                    </div>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tr>
            ...
            <!-- Action Buttons -->
            <td>
                <button type="button" class="btn btn-soft-secondary btn-sm" onclick="openEditModalFromDetail({
                        id_ca: <?= $row['id_ca'] ?>,
                ...
                ?>
                <button type="button" class="btn btn-soft-info btn-sm" onclick="openSettlementModalFromDetail(<?= $row['id_ca'] ?>, '<?= addslashes($row['deskripsi']) ?>')">
                    <i class="ri-exchange-funds-fill align-bottom me-2 text-muted"></i>Settle
                </button>
                <?php 
                // For Settled status
                elseif ($row['status'] == 'Settled'): 
                ...
                ?>
                <button type="button" class="btn btn-soft-primary btn-sm" onclick="openRefundModalFromDetail(<?= $row['id_ca'] ?>, '<?= addslashes($row['deskripsi']) ?>', <?= $selisih ?>)">
                    <i class="ri-refund-2-line align-bottom me-2 text-muted"></i>Pengembalian
                </button>
                <?php 
                    else: 
                    // If no selisih or negative selisih, show Complete button
                ?>
                <button type="button" class="btn btn-soft-dark btn-sm" onclick="completeCAFromDetail(<?= $row['id_ca'] ?>)">
                    <i class="ri-checkbox-circle-line align-bottom me-2 text-muted"></i>Complete
                </button>
                <?php 
                    endif;
                endif; 
...
$(document).ready(function () {
    ...
    var table = $('#caTable').DataTable({
        ...
        columnDefs: [
            ...
            { targets: [4, 7, 8, 9, 10, 12], visible: false }
        ],
