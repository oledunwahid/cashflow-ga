...
// Simpan pesan dari session ke variabel temporary 
$message = isset($_SESSION['Messages']) ? $_SESSION['Messages'] : '';
$icon = isset($_SESSION['Icon']) ? $_SESSION['Icon'] : '';

// Hapus session setelah disimpan ke variabel
                                ...
                                <div class="p-2 mt-4">
                                    <form class="js-validation-signin" action="systemlogin.php" method="POST">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="yes" name="remember" id="auth-remember-check">
